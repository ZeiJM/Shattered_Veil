...
export const TERRAIN = {
  ...
  water: {
    label: "Shallow Water",
    ds: "Slow to wade through. Lightning will arc here in future passes.",
  ...
  forest: {
    ...
    moveCost: 1,
    rare: true,
    bonusHint: "Nature regen",
  },
  stone: {
    label: "Cracked Flagstone",
    ds: "Hard footing. Earth-aligned techniques root well.",
    cls: "sv-arena-tile-stone",
    moveCost: 1,
  },
  highGround: {
    label: "High Ground",
    ds: "Raised terrace. Future ranged bonus.",
    cls: "sv-arena-tile-highground",
    moveCost: 1,
  },
  brokenVeil: {
    label: "Broken Veil",
    ds: "The Veil is paper-thin here. Veil Magic generation accelerates.",
    cls: "sv-arena-tile-brokenveil",
    moveCost: 1,
    rare: true,
    bonusHint: "Veilbreak charge +",
  },
  hallowed: {
    label: "Hallowed Stone",
