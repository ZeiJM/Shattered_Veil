        ...
        <div className="cd page-panel" style={{ padding: 10 }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 4 }}>
            <div style={{ display: "grid", gridTemplateColumns: "34px 34px 34px", gridTemplateRows: "34px 34px 34px", gap: 1 }}>
              ...
              {(() => { const onOcean = tile && tile.bio === "ocean"; const canFish = nearOcean || onOcean; const fishingCD = fishCD > timerNow; return (
              <button className="bt bs" type="button" style={{ background: tile && tile.poi ? T.gd : canFish ? "#0288d1" : T.c2, width: 34, height: 34, fontSize: 8, fontWeight: 700, touchAction: "manipulation", display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center", lineHeight: 1.05, padding: 0 }} onClick={() => { if (!tile || !tile.poi) { if (canFish && !fishingCD) { runFishing(); } return; } const tp = tile.poi.type; if (tp === "hostile" || tp === "outpost") enterHostilePoi(); else if (tp === "rift") enterRiftPoi(); else enterPoi(); }}>{tile && tile.poi ? "Enter" : (canFish ? (fishingCD ? (Math.ceil((fishCD - timerNow)/1000) + "s") : "Fish") : "·")}</button>
              ); })()}
